...
var TimesIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var Portal = React5.memo(function(inProps) {
  ...
  var _React$useState = React5.useState(props.visible && DomHandler.isClient()), _React$useState2 = _slicedToArray(_React$useState, 2), mountedState = _React$useState2[0], setMountedState = _React$useState2[1];
...
var Tooltip = React6.memo(React6.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React6.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  var _React$useState3 = React6.useState(props.position || "right"), _React$useState4 = _slicedToArray2(_React$useState3, 2), positionState = _React$useState4[0], setPositionState = _React$useState4[1];
  var _React$useState5 = React6.useState(""), _React$useState6 = _slicedToArray2(_React$useState5, 2), classNameState = _React$useState6[0], setClassNameState = _React$useState6[1];
  var _React$useState7 = React6.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), multipleFocusEvents = _React$useState8[0], setMultipleFocusEvents = _React$useState8[1];
  ...
  _proto.handleExited = function handleExited(child, node) {
    ...
    if (this.mounted) {
      this.setState(function(state2) {
        var children2 = _extends6({}, state2.children);
...
var SearchIcon = React14.memo(React14.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React14.createElement("svg", _extends7({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var VirtualScroller = React15.memo(React15.forwardRef(function(inProps, ref) {
  ...
  var _React$useState5 = React15.useState(0), _React$useState6 = _slicedToArray3(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  ...
  var _React$useState9 = React15.useState(props.numToleratedItems), _React$useState10 = _slicedToArray3(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React15.useState(props.loading || false), _React$useState12 = _slicedToArray3(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React15.useState([]), _React$useState14 = _slicedToArray3(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  ...
  var viewInitialized = React15.useRef(false);
  var _useResizeListener = useResizeListener({
    listener: function listener(event) {
      return onResize();
    },
  ...
  var createLoader = function createLoader2() {
    ...
    var icon = props.loadingIcon || React15.createElement(SpinnerIcon, _extends8({}, loadingIconProps, {
      spin: true
    }));
...
var Ripple = React16.memo(React16.forwardRef(function(inProps, ref) {
  var _React$useState = React16.useState(false), _React$useState2 = _slicedToArray4(_React$useState, 2), isMounted = _React$useState2[0], setMounted = _React$useState2[1];
  var inkRef = React16.useRef(null);
  var targetRef = React16.useRef(null);
  var mergeProps = useMergeProps();
  ...
  return React16.createElement("span", _extends9({
    role: "presentation",
    ref: inkRef
  }, rootProps, {
    onAnimationEnd
...
var CheckIcon = React17.memo(React17.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
function _slicedToArray5(r, e) {
  return _arrayWithHoles5(r) || _iterableToArrayLimit5(r, e) || _unsupportedIterableToArray$1(r, e) || _nonIterableRest5();
}
...
var BlankIcon = React18.memo(React18.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React18.createElement("svg", _extends11({
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, pti), React18.createElement("rect", {
    width: "1",
    height: "1",
    fill: "currentColor",
    fillOpacity: "0"
...
var DropdownItem = React18.memo(function(props) {
  ...
  var iconRenderer = function iconRenderer2() {
    if (selected) {
      ...
      return React18.createElement(CheckIcon, checkIconProps);
    }
    var blankIconProps = mergeProps({
      className: cx("blankIcon")
    }, getPTOptions("blankIcon"));
    return React18.createElement(BlankIcon, blankIconProps);
  };
  return React18.createElement("li", _extends11({
    key: props.label
  }, itemProps), checkmark && iconRenderer(), React18.createElement("span", itemGroupLabelProps, content), React18.createElement(Ripple, null));
});
...
var DropdownPanel = React18.memo(React18.forwardRef(function(props, ref) {
  ...
  var createFooter = function createFooter2() {
    if (props.panelFooterTemplate) {
      ...
      return React18.createElement("div", footerProps, content);
    }
    return null;
  };
  ...
  var createEmptyMessage = function createEmptyMessage2(emptyMessage, isFilter) {
    ...
    return React18.createElement("li", emptyMessageProps, message);
  };
  var createItem = function createItem2(option, index) {
    ...
    if (option.group && props.optionGroupLabel) {
      ...
      return React18.createElement("li", _extends11({
        key
      }, itemGroupProps), React18.createElement("span", itemGroupLabelProps, groupContent));
    }
  ...
  var createFilterClearIcon = function createFilterClearIcon2() {
    if (props.showFilterClear && props.filterValue) {
      ...
      var icon = props.filterClearIcon || React18.createElement(TimesIcon, clearIconProps);
  ...
  var createFilter = function createFilter2() {
    if (props.filter) {
      ...
      var icon = props.filterIcon || React18.createElement(SearchIcon, filterIconProps);
      ...
      var content = React18.createElement("div", filterContainerProps, React18.createElement("input", filterInputProps), clearIcon, filterIcon);
      ...
      return React18.createElement("div", headerProps, content);
    }
    return null;
  };
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      var virtualScrollerProps = _objectSpread$1(_objectSpread$1({}, props.virtualScrollerOptions), {
        ...
        contentTemplate: function contentTemplate(options) {
          ...
          return React18.createElement("ul", listProps2, content);
        }
      });
      return React18.createElement(VirtualScroller, _extends11({
    ...
    return React18.createElement("div", wrapperProps, React18.createElement("ul", listProps, items));
  };
  var createElement12 = function createElement13() {
    ...
    return React18.createElement(CSSTransition2, _extends11({
      nodeRef: ref
    }, transitionProps), React18.createElement("div", _extends11({
      ref
...
var Dropdown = React18.memo(React18.forwardRef(function(inProps, ref) {
  ...
  var _useDebounce = useDebounce("", props.filterDelay || 0), _useDebounce2 = _slicedToArray5(_useDebounce, 3), filterValue = _useDebounce2[0], filterState = _useDebounce2[1], setFilterState = _useDebounce2[2];
  var _React$useState = React18.useState(false), _React$useState2 = _slicedToArray5(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var _React$useState3 = React18.useState(-1), _React$useState4 = _slicedToArray5(_React$useState3, 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
  ...
  var clickedRef = React18.useRef(false);
  var elementRef = React18.useRef(null);
  var overlayRef = React18.useRef(null);
  var firstHiddenFocusableElementOnOverlay = React18.useRef(null);
  var lastHiddenFocusableElementOnOverlay = React18.useRef(null);
  ...
  var flatOptions = function flatOptions2(options) {
    return (options || []).reduce(function(result, option, index) {
      result.push(_objectSpread5(_objectSpread5({}, option), {}, {
        group: true,
        index
      }));
  ...
  var createHiddenSelect = function createHiddenSelect2() {
    ...
    return React18.createElement("div", hiddenSelectedMessageProps, React18.createElement("select", selectProps, React18.createElement("option", optionProps, option.label)));
  };
  var createKeyboardHelper = function createKeyboardHelper2() {
    ...
    return React18.createElement("div", hiddenSelectedMessageProps, React18.createElement("input", inputProps));
  };
  var createLabel = function createLabel2() {
    ...
    if (props.editable) {
      ...
      return React18.createElement("input", _inputProps);
    }
    var content = props.valueTemplate ? ObjectUtils.getJSXElement(props.valueTemplate, selectedOption, props) : label || props.placeholder || props.emptyMessage || React18.createElement(React18.Fragment, null, " ");
    ...
    return React18.createElement("span", inputProps, content);
  };
  ...
  var createClearIcon = function createClearIcon2() {
    if (props.value != null && props.showClear && !props.disabled && !ObjectUtils.isEmpty(props.options)) {
      ...
      var icon = props.clearIcon || React18.createElement(TimesIcon, clearIconProps);
  ...
  var createLoadingIcon = function createLoadingIcon2() {
    ...
    var icon = props.loadingIcon || React18.createElement(SpinnerIcon, {
      spin: true
    });
    ...
    return React18.createElement("div", loadingButtonProps, loadingIcon);
  };
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = !overlayVisibleState ? props.dropdownIcon || React18.createElement(ChevronDownIcon, dropdownIconProps) : props.collapseIcon || React18.createElement(ChevronUpIcon, dropdownIconProps);
    ...
    return React18.createElement("div", triggerProps, dropdownIcon2);
  };
  ...
  return React18.createElement(React18.Fragment, null, React18.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React18.createElement(DropdownPanel, _extends11({
    hostName: "Dropdown",
    ref: overlayRef,
    visibleOptions,
    virtualScrollerRef
    ...
    firstFocusableElement: React18.createElement("span", firstHiddenFocusableElementProps),
    lastFocusableElement: React18.createElement("span", lastHiddenFocusableElementProps),
    sx
  }))), hasTooltip && React18.createElement(Tooltip, _extends11({
    target: elementRef,
